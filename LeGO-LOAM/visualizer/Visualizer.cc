...
void Visualizer::UpdateMarker(visualization_msgs::Marker &marker, const pllo::Transform &pose) {
...
void Visualizer::UpdateMarkers(std::vector<pllo::Transform> imu_poses, std::vector<pllo::Transform> lidar_poses) {
