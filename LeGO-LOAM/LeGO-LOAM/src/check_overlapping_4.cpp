...
int main(int argc, char** argv)
{
	...
	ros::init(argc, argv, "check_overlapping 4");
	...
	// trajectory_8_shape
// 	tf_top_tail <<  -0.98516, 0.17115, -0.013091, -0.8187, -0.17058, -0.98467, -0.036417, 0.53469, -0.019123, -0.033644, 0.99925, -1.1817, 0, 0,   0,  1;
	
	// trajectory_eclipse
	tf_top_tail << -0.99437, 0.10598, -0.0006967, -0.33939, -0.10593, -0.99409, -0.023676, 1.262, -0.0032017, -0.023468, 0.99972, -1.1037, 0, 0, 0, 1.0000;
...
// 	v_str_bag_file.push_back("/home/jjiao/catkin_ws/src/localization/LeGO-LOAM/LeGO-LOAM/data/yellow_20190104/8_shape/odom_tail.bag");
	...
	v_str_bag_file.push_back("/home/jjiao/catkin_ws/src/localization/LeGO-LOAM/LeGO-LOAM/data/yellow_20190104/eclipse/odom_tail.bag");	
	...
	PM::ICP icp;
	std::string fn_config("/home/jjiao/catkin_ws/src/localization/LeGO-LOAM/LeGO-LOAM/config/icp_surf_top_tail.yaml");
	...
	std::string filename = "/home/jjiao/Documents/matlab_ws/matlab_multi_lidar_cal/iros_2019/data/refinement_data/top_tail_estimated.txt";
    std::ofstream ofs(filename.c_str(), std::ios::out | std::ios::binary);
// 	ofs << "#index px py pz qw qx qy qz omega normal" << std::endl;
...
// 		iniT = finalT;
		...
		while (true)
		{
			...
			pubDataCloudIniTrans.publish(PointMatcher_ros::pointMatcherCloudToRosMsg<float>
				(rigidTrans->compute(data_lidar_cloud, tf_top_tail), header.frame_id, header.stamp));			
