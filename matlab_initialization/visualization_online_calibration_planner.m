...
Tform_gt_lidar_2_lidar_3 = Tform_gt_lidar_1_lidar_2^(-1) * Tform_gt_lidar_1_lidar_3;
...
%         lidar_3_data = odom_obtain_from_bag(bag_file, 'Transformation of tail lidar', 3, '/odom_from_tail_lidar', b_plot_odom, b_noise);
        ...
        bag_file = '/Monster/dataset/lidar_calibration/simulation_20181128/loop_2.bag';
...
%         if (strcmp(str_initializer, 'matrix'))
            ...
            fprintf('Kabsch: lidar_1 to lidar_3\n'); 
            angle = rotm2eul(ini_X(1:3,1:3))/pi*180;
...
%         elseif (strcmp(str_initializer, 'quaternion'))
            ...
            fprintf('Proposd: lidar_1 to lidar_3\n'); 
            angle = rotm2eul(ini_X(1:3,1:3))/pi*180;
            fprintf('Euler y p r:\n%f %f %f \n', angle(1), angle(2), angle(3));             
            disp(rotm2quat(ini_X(1:3,1:3)));
            disp(ini_X(1:3,4)');   
...
rotm2eul(ini_X(1:3,1:3))/pi*180        
disp('Guess: lidar_1 to lidar_3'); disp(ini_X);
disp('GT: lidar_1 to lidar_3'); disp(Tform_gt_lidar_2_lidar_3);            
